...
public struct DraggableMapView: View {
    @ObservedObject public var mesh: Mesh
    @ObservedObject public var selection: SelectionHandler
    ...
    public init(mesh: Mesh, selection: SelectionHandler) {
        self.mesh = mesh
...
struct SurfaceView_Previews: PreviewProvider {
    static var previews: some View {
        ...
        return DraggableMapView(mesh: mesh, selection: selection)
    }
}

private extension DraggableMapView {
    // 1
